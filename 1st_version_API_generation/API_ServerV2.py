...
def obtener_todos_los_versiculos_posibles() -> set[str]:
    ...
    return {
        ...
        "テサロニケ人への手紙第一 5:11",
        "テサロニケ人への手紙第一 5:19",
        "テサロニケ人への手紙第一 5:21-22",
        "テサロニケ人への手紙第一 5:23-24",
        "テサロニケ人への手紙第二 2:13-14",
        "テサロニケ人への手紙第二 3:10",
        "テトスへの手紙 1:5-9",
        "テトスへの手紙 2:11-14",
        "テトスへの手紙 3:4-5",
...
async def generate_devocional_content_gemini(
    ...
    try:
        ...
        if "versiculo" in devocional_data:
            ...
            texto_bruto_con_prefijo = (
                (parts[1] if len(parts) > 1 else devocional_data["versiculo"])
                .strip()
                .strip('"')
            )
